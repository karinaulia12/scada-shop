...
<body class="goto-here">
	...
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
		<div class="container">
			<a class="navbar-brand text-primary" href="<?php echo base_url(); ?>"><?php echo get_store_name(); ?></a>
			...
			<div class="collapse navbar-collapse" id="ftco-nav">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item cta cta-info"><a href="<?php echo site_url('shop/cart'); ?>" class="nav-link text-info"><span class="icon-shopping_cart"></span>[<span class="cart-item-total">0</span>]</a></li>
