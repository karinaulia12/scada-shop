...
?>
<div class="hero-wrap hero-bread" style="background-image: url('<?php echo get_theme_uri('images/9.webp'); ?>');">
  <div class="container">
    <div class="row no-gutters slider-text align-items-center justify-content-center">
      <div class="col-md-9 ftco-animate text-center">
        <p class="breadcrumbs"><span>Keranjang Belanja</span></p>
      ...
      <form action="<?php echo site_url('shop/checkout'); ?>" method="POST">
        ...
        <div class="row justify-content-end">
          ...
          <div class="col-lg-4 mt-5 cart-wrap ftco-animate">
            ...
            <p><button type="submit" class="btn btn-info py-3 px-4">Checkout</button></p>
          </div>
        </div>
      </form>
    <?php else : ?>
      <div class="row">
        <div class="col-md-12 ftco-animate">
          <div class="alert alert-info">Tidak ada barang dalam keranjang.<br><a href="<?php echo base_url(); ?>">Jelajahi produk kami</a> dan mulailah berbelanja!</div>
        </div>
      </div>
    <?php endif; ?>
  </div>
