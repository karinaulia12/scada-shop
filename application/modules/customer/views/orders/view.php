                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="card card-primary">
                                ...
                                <div class="card-body p-0">
                                    <table class="table align-items-center table-striped table-flush table-hover">
                                        <tr>
                                            <td>Nama</td>
                                    ...
                                    <?php else : ?>
                                        <table class="table align-items-center table-striped table-flush table-hover">
                                            ...
                                            <tr>
                                                <td>Tanggal</td>
                                                <td>
                                                    <div style="white-space: initial;"><b><?php echo get_formatted_date($data->payment_date); ?></b></div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Status</td>
                                            ...
                                            <tr>
                                                <td>Transfer dari</td>
                                                <td>
                                                    <div style="white-space: initial;"><b><?php echo $transfer_from->bank; ?> a.n <?php echo $transfer_from->name; ?> (<?php echo $transfer_from->number; ?>)</b></div>
                                                </td>
                                            </tr>
                                        </table>
                                    <?php endif; ?>
                                    ...
                                    <div class="text-center actionRow">
                                        <?php if ($data->payment_method == 1) : ?>
                                            <?php if ($data->order_status == 1) : ?>
                                                ...
                                                <a href="<?php echo site_url('customer/payments/confirm?order=' . $data->id); ?>" class="btn btn-success mb-2">Konfirmasi Pembayaran</a>
                                                <br>
