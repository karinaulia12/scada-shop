            ...
            <div class="col-md-3">
              ...
              <div class="card card-primary card-outline mb-4">
                <div class="card-body box-profile">
                  ...
                  <h3 class="profile-username text-center mt-3"><?php echo get_user_name(); ?></h3>
              ...
              <div class="card">
                <div class="card-header p-2">
                  <ul class="nav nav-pills">
                    <li class="nav-item mx-1"><a class="nav-link profil active" href="#profile" data-toggle="tab">Profil</a></li>
                    <li class="nav-item mx-1"><a class="nav-link akun " href="#akun" data-toggle="tab">Akun</a></li>
                    <li class="nav-item mx-1"><a class="nav-link email" href="#email" data-toggle="tab">Email</a></li>
