...
<div class="container-fluid mt--6">
  <div class="row">
    ...
    <tr>
      ...
      <td>
        <div style="white-space: initial;">
          <b>Rp <?php echo format_rupiah($product->current_discount); ?> (<?php echo count_percent_discount($product->current_discount, $product->price, 2); ?> %)</b>
        </div>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>:</td>
      <td>
        <div style="white-space: initial;"><b><?php echo $product->description; ?></b></div>
      </td>
    </tr>
    <tr>
      <td>Tersedia</td>
